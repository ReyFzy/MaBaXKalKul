export const HeadSection =()=> {
    return (
        <>
            <div className="bg-vector p-1 gap-8 w-full h-[581px] column items-center justify-start">
                ...
                <div className="column gap-4 items-center">
                    ...
                    <div className="column items-center gap-6">
                        <h1 className="rubik-bold font-extrabold text-center text-4xl">Cobain deh Appetizer & Dessert nya <a href="https://www.instagram.com/rpl2.twotech/" className="font-lobster-two text-macaroni">RPL 2</a></h1>
                        <a href="#menu">
