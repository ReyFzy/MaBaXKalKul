    ...
    return(
        <>
            <div className="w-full p-3 bg-macaroni/70 max-h-[100px] rounded-tr-xl rounded-tl-xl column items-center text-white">
                ...
                <a href="https://wa.me/6285877547692?text=Halo%20Min%20Aku%20Mau%20Bertanya%20%F0%9F%98%8B%0A%0A" className="font-lobster-two font-bold text-2xl pt-3 z-10">MaBa X KalKul</a>
